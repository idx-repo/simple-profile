 ...
 *
 * The followings are the available columns in table 'shareholders':
 * @property integer $id
 * @property integer $comp_id
 * @property string $name
 * @property string $shares
 */
class shareholders extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, comp_id, name, shares', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return shareholders the static model class
	 */
